...
\begin{align}
\underbrace{\mu_{\mathrm{s}}\nabla^2\mathbf{u}_{\mathrm{s}}}_{\text{first\,term}}+\left(\lambda_{\mathrm{s}}+\mu_{\mathrm{s}}\right)\nabla\nabla\cdot\mathbf{u}_{\mathrm{s}} - \rho_{\mathrm{s}}{\ddot{\mathbf{u}}}_{\mathrm{s}}=0,
...
\begin{figure}[h]
  ...
  \caption{Moving load on an infinite Euler-Bernoulli beam}
